          ...
          {[
            {
              ...
              icon: <Icon icon="heroicons:user-group" className="w-6 h-6" />,
            },
            {
              title: "Designation",
              position: "Lead UX/UI Designer",
              icon: <Icon icon="heroicons:web-browser" className="w-6 h-6" />,
            },
            {
              title: "Mail",
              position: "jennyfer.frankin@gmail.com",
              icon: <Icon icon="heroicons:mail" className="w-6 h-6" />,
            },
          ].map((item, index) => (
